...
HD_PWD='/home/ukallakuri/hardware_design/designs/_N4DDA7-DS/_N4DDA7-DS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ds_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ds_top_wrapper.tcl
