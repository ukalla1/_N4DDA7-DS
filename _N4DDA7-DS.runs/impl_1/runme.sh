...
HD_PWD='/home/ukallakuri/hardware_design/designs/_N4DDA7-DS/_N4DDA7-DS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ds_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ds_top_wrapper.tcl -notrace
